...
module.exports = function(app){
  ...
  app.get('/wppost/:id', function(req, res,next){
    ...
    log('/get /wppost/' + req.params.id + '?lang=' +req.query.lang, true);
    ...
    getWpPostMetaWeblog(req.params.id)
    .then(function(post){
        debugger;
        ...
        allPosts[thisLanguage]=req.params.id;
        //log(JSON.stringify(allPosts));
